...
check('A8 注册了 Tool（memory×3 + setup×3）', h1.counts().toolsRegistered === 6,
...
check('B2 Tool 仍然注册（插件核心可用）', h2.counts().toolsRegistered === 6,
...
check('C2 Tool 仍 6 个', h3.counts().toolsRegistered === 6)
